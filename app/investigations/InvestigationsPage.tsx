        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <ScrollReveal delay={0.1}>
              <Link
                href="/investigations/whistleblowing"
                className="block h-full rounded-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold"
              >
                <Card className="h-full group cursor-pointer flex flex-col">
                  ...
                  <h3 className="font-heading text-2xl font-bold text-forest-dark mb-3 group-hover:text-burgundy transition-colors">Whistleblowing</h3>
                  ...
                  <span className="mt-auto inline-flex items-center gap-2 text-burgundy font-body font-semibold tracking-[0.05em] group-hover:text-burgundy-dark transition-colors">
            ...
            <ScrollReveal delay={0.2}>
              ...
              >
                <Card className="h-full group cursor-pointer flex flex-col">
                  ...
                  <h3 className="font-heading text-2xl font-bold text-forest-dark mb-3 group-hover:text-burgundy transition-colors">FOI Investigations</h3>
